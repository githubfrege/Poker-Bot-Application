            ...
            if (holeCards.Count == 2)
            {
                ...
                //{
                    ...
                    else
                    {
                        ...
                        int betAmount = BotOperations.WhatToBet(odds, int.Parse(tableChipsTxt.Text), int.Parse(opponentBetTxt.Text), int.Parse(myChipsTxt.Text),1000, out float expectedValue);
                        if (!(expectedValue > 0)) {
